  ...
  `}
          >
            ...
            <div className="flex items-center justify-between border-b border-gray-200 px-5 py-5 shrink-0">
              ...
              <button
                onClick={() => toggleCart(false)}
                className="text-black hover:bg-gray-100 cursor-pointer rounded-full p-2 transition"
              >
                <X size={22} />
              </button>
            ...
            {items.length > 0 && (
              <div className="border-t border-gray-200 px-6 pt-5 pb-8 sm:pb-6">
                ...
                <button
                  ...
                  className="
                  mt-6 h-[52px] w-full rounded-md text-sm font-semibold text-white
                  transition-all duration-300 hover:scale-[1.02] active:scale-95
                "
                  style={{
                    background: "linear-gradient(180deg,#7A00FF 0%,#D94CF7 100%)",
                  }}
                >
